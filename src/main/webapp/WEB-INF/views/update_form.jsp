		...
		<html lang="en">
		  ...
		  <body>
				...
				<div class="container">		
					...
					<form action="${pageContext.request.contextPath }/empHandler" method="post">
					...
					<input type="hidden" id="id" name="id" value="${employee.id}">
					  ...
					  <div class="form-group">
					    ...
					    placeholder="Enter Employee city name" value="${employee.city }">
					  </div>
					  ...
					  <div class="form-group">
					    ...
					    placeholder="Enter Employee city name" value="${employee.salary }">
					  </div>
